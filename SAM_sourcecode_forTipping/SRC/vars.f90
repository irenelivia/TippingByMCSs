...
real misc(nx, ny, nz)
! storage of velocity on previous time step to avoid extra boundary exchange:
...
real  sst_cor !  integral correction to the ocean slab layer model
...
real prec_xy(nx,ny) ! mean precip. rate for output
real shf_xy(nx,ny) ! mean sensible heat flux for output
real lhf_xy(nx,ny) ! mean latent heat flux for output
...
! RF additions
real qt1300_xy(nx,ny) ! total water fraction at 1300 m altitude
real t1300_xy(nx,ny) ! static temperature at 1300 m altitude
real p1300_xy(nx,ny) ! static pressure at 1300 m altitude
real u1300_xy(nx,ny) ! u-wind at 1300 m altitude
real v1300_xy(nx,ny) ! v-wind at 1300 m altitude
real w1300_xy(nx,ny) ! w-wind at 1300 m altitude
real qt3500_xy(nx,ny) ! total water fraction at 3500 m altitude
real t3500_xy(nx,ny) ! static temperature at 3500 m altitude
real p3500_xy(nx,ny) ! static pressure at 3500 m altitude
real u3500_xy(nx,ny) ! u-wind at 3500 m altitude
real v3500_xy(nx,ny) ! v-wind at 3500 m altitude
real w3500_xy(nx,ny) ! w-wind at 3500 m altitude
real wsrfc_xy(nx,ny) ! w-wind at first level
real tsrfc_xy(nx,ny) ! static temperature at first level
real qvsrfc_xy(nx,ny) ! water vapor fraction at first level
