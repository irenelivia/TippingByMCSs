...
module domain
       ...
       integer, parameter :: nx_gl = 120!1024!512!1024!6144  ! Number of grid points in X
       integer, parameter :: ny_gl = 120!1024!512!1024!1024  ! Number of grid points in Y
       integer, parameter :: nz_gl = 64 !100 !64 ! Number of pressure (scalar) levels
       integer, parameter :: nsubdomains_x  = 15!16!32 !64  No of subdomains in x
       integer, parameter :: nsubdomains_y  = 8!32!  No of subdomains in y

       ! Remember: for efficient pressure solver in mpi,
       ! mod(nx_gl,nsubdomains) and (ny_gl,nsubdomains) must be null
